...
export default {
    ...
    methods: {
        ...
        async loadAllData() {
            ...
            try {
                ...
                this.$store.commit('SET_CHANGABLE_BOATS', allData)
    ...
    created() {
        ...
        if (this.$store.state.changableDateBoats && this.$store.state.changableDateBoats.length) {
            this.allItems = this.$store.state.changableDateBoats
        }
    }
}
</script>
